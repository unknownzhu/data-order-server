...
(function (domGlobals) {
    ...
    var link = function (editor, attachState, data) {
        ...
        editor.undoManager.transact(function () {
            ...
            //下载文件名称！！！
            linkAttrs.download = attachState.download;
    ...
    var init = function (initialData, linkSettings) {
        ...
        var onUrlChange = function (data) {
            if (persistentText.get().length <= 0) {
                ...
                //   return Option.some({ text: 'abv' });

                return Option.some({text: Window.fileNames});
    ...
    var preprocess = function (editor, assumeExternalTargets, data) {
        console.log('tewwe', assumeExternalTargets, data);
        return findMap([
            tryEmailTransform,
