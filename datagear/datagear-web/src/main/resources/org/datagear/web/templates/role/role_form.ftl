...
<div id="${pageId}" class="page-form page-form-role">
	...
	<#--		<div class="form-item">
				<div class="form-item-label">
					<label><@spring.message code='role.dataType' /></label>
				</div>
				<div class="form-item-value">
					<div class="roleEnabled-radios">
						<input type="radio" id="${pageId}-dataType" name="dataType" value="0" <#if !((role.dataType)!false)>checked="checked"</#if> />
						<label for="${pageId}-dataType0"><@spring.message code='dataType0' /></label>
						<input type="radio" id="${pageId}-dataType" name="dataType" value="1" <#if (role.dataType)!false>checked="checked"</#if> />
						<label for="${pageId}-dataType1"><@spring.message code='dataType1' /></label>
						<input type="radio" id="${pageId}-dataType" name="dataType" value="2" <#if (role.dataType)!false>checked="checked"</#if> />
						<label for="${pageId}-dataType2"><@spring.message code='dataType2' /></label>
					</div>
				</div>
			</div>-->
