...
<head>
   ...
   <script src="/data-order-server/component/layui/layui.js" charset="utf-8"></script>
    <script src="/data-order-server/htmls/common.js" charset="utf-8"></script>
...
<body id="${pageId}">
<div class="main-page-head" style="height:1px;display: none">
    ...
    <div class="toolbar">
        <ul id="systemSetMenu" class="lightweight-menu">
            <li class="system-set-root"><span><span class="ui-icon ui-icon-gear"></span><span
                            class="new-version-tip"></span></span>
                <ul style="display:none;" class="ui-widget-shadow">
                    <#if !currentUser.anonymous>
                        <#if currentUser.admin>
                            <li class="system-set-driverEntity"><a
                                        href="javascript:void(0);"><@spring.message code='main.manageDriverEntity' /></a>
                            </li>
                            <li class="system-set-schemaUrlBuilder"><a
                                        href="javascript:void(0);"><@spring.message code='schemaUrlBuilder.schemaUrlBuilder' /></a>
                            </li>
                            <li class="system-set-authorization"><a
                                        href="javascript:void(0);"><@spring.message code='main.manageSchemaAuth' /></a>
                            </li>
                            <li class="ui-widget-header"></li>
                            <li class="system-set-user"><a
                                        href="javascript:void(0);"><@spring.message code='main.manageUser' /></a></li>
                            <li class="system-set-role"><a
                                        href="javascript:void(0);"><@spring.message code='main.manageRole' /></a></li>
                        </#if>
                        <li class="system-set-personalSet"><a
                                    href="javascript:void(0);"><@spring.message code='main.personalSet' /></a></li>
                        <li class="ui-widget-header"></li>
                    </#if>
                </ul>
            </li>
...
<div class="main-page-content" style="margin-top: -29px">
        ...
        <div id="${pageId}-nav" class="main-nav">
            ...
            <div id="${pageId}-nav-dataSource" class="ui-widget ui-widget-content schema-panel">
                <div class="schema-panel-head" show-any-role="${Role.ROLE_DATA_ADMIN},${Role.ROLE_DATA_ANALYST}">
                    <div class="schema-panel-form ui-widget ui-widget-content ui-corner-all" style="width: 100%">
                        <form id="schemaSearchForm" action="javascript:void(0);" style="width: 100%">
                            <div id="schemaSearchSwitch" class="schema-search-switch ui-button-icon-only"><span
                                        class="ui-icon ui-icon-calculator search-switch-icon"
                                        title="<@spring.message code='main.searchTable' />"></span></div>
                            <div class="keyword-input-parent"><input name="keyword" id="keyword" type="text" value=""
                                                                     class="ui-widget ui-widget-content keyword-input"/>
                            </div>
                            <button type="submit"
                                    class="ui-button ui-corner-all ui-widget ui-button-icon-only search-button"><span
                                        class="ui-icon ui-icon-search"></span><span
                                        class="ui-button-icon-space"> </span><@spring.message code='find' /></button>
                            <input name="pageSize" type="hidden" value="100"/>
                        </form>
                    </div>
                    <div class="schema-panel-operation"
                         show-any-role="${Role.ROLE_DATA_ADMIN},${Role.ROLE_DATA_ANALYST}">
                        <#-- <button id="addSchemaButton"
                                 class="ui-button ui-corner-all ui-widget ui-button-icon-only add-schema-button"
                                 visible-any-role="${Role.ROLE_DATA_ADMIN}"
                                 title="<@spring.message code='main.addSchema' />"><span
                                     class="ui-button-icon ui-icon ui-icon-plus"></span><span
                                     class="ui-button-icon-space"> </span><@spring.message code='add' /></button>-->
                        <ul id="schemaOperationMenu" class="lightweight-menu">
                                ...
                                <ul style="display:none;" class="ui-widget-shadow">
                                    <#if !currentUser.anonymous>
                                        <#if currentUser.admin>
                                            ...
                                            <li class="ui-widget-header"></li>
                                            <li class="system-set-user"><a
                                                        href="javascript:void(0);"><@spring.message code='main.manageUser' /></a>
                                            </li>
                                            <li class="system-set-role"><a
                                                        href="javascript:void(0);"><@spring.message code='main.manageRole' /></a>
                                            </li>
                                        </#if>
                                        <li class="system-set-personalSet"><a
                                                    href="javascript:void(0);"><@spring.message code='main.personalSet' /></a>
                                        </li>
                                        <li class="ui-widget-header"></li>
                                    </#if>
                            ...
                            <#--    <li class="schema-operation-root"><span><span
                                                class="ui-icon ui-icon-triangle-1-s"></spanqud></span>
                                    <ul class="ui-widget-shadow">
                                        <li class="schema-operation-edit" show-any-role="${Role.ROLE_DATA_ADMIN}"><a
                                                    href="javascript:void(0);"><@spring.message code='edit' /></a></li>
                                        <li class="schema-operation-delete" show-any-role="${Role.ROLE_DATA_ADMIN}"><a
                                                    href="javascript:void(0);"><@spring.message code='delete' /></a></li>
                                        <li class="schema-operation-view"><a
                                                    href="javascript:void(0);"><@spring.message code='view' /></a></li>
                                        <li class="schema-operation-refresh"
                                            title="<@spring.message code='main.schemaOperationMenuRefreshComment' />"><a
                                                    href="javascript:void(0);"><@spring.message code='refresh' /></a></li>
                                        <li class="schema-operation-authorize" show-any-role="${Role.ROLE_DATA_ADMIN}"><a
                                                    href="javascript:void(0);"><@spring.message code='authorize' /></a></li>
                                        <li class="ui-widget-header"></li>
                                        <li class="schema-operation-reload"
                                            title="<@spring.message code='main.schemaOperationMenuReloadComment' />"><a
                                                    href="javascript:void(0);"><@spring.message code='reload' /></a></li>
                                        <li class="ui-widget-header"></li>
                                        <li class="schema-operation-sqlpad"><a
                                                    href="javascript:void(0);"><@spring.message code='main.sqlpad' /></a>
                                        </li>
                                        <li class="ui-widget-header"></li>
                                        <li class="schema-operation-dataimport"><a
                                                    href="javascript:void(0);"><@spring.message code='main.dataimport' /></a>
                                        </li>
                                        <li class="schema-operation-dataexport"><a
                                                    href="javascript:void(0);"><@spring.message code='main.dataexport' /></a>
                                        </li>
                                    </ul>
                                </li>-->
                        </ul>
            ...
            <#--   <div id="${pageId}-nav-dataAnalysis"
                    class="ui-widget ui-widget-content dataAnalysis-panel">
                   <div class="dataAnalysis-panel-head" show-any-role="${Role.ROLE_DATA_ADMIN},${Role.ROLE_DATA_ANALYST}">
                       <div class="analysis-project-current ui-widget ui-widget-content ui-corner-all">
                           <div class="analysis-project-current-value"
                                title="<@spring.message code='main.analysisProject.currentValue' />"></div>
                           <div class="analysis-project-current-reset ui-button-icon-only"
                                title="<@spring.message code='main.analysisProject.currentValue.clear' />">
                               <span class="ui-icon ui-icon-cancel"></span>
                           </div>
                       </div>
                       <div class="analysis-project-operation">
                           <div class="analysis-project-operation-group" show-any-role="${Role.ROLE_DATA_ADMIN}">
                               <button id="addAnalysisProjectButton"
                                       class="ui-button ui-corner-all ui-widget ui-button-icon-only add-analysis-project-button"
                                       title="<@spring.message code='main.analysisProject.add' />"><span
                                           class="ui-button-icon ui-icon ui-icon-plus"></span><span
                                           class="ui-button-icon-space"> </span><@spring.message code='add' /></button>
                               <button id="manageAnalysisProjectButton"
                                       class="ui-button ui-corner-all ui-widget ui-button-icon-only manage-analysis-project-button"
                                       title="<@spring.message code='main.analysisProject.manage' />"><span
                                           class="ui-button-icon ui-icon ui-icon-triangle-1-s"></span><span
                                           class="ui-button-icon-space"> </span><@spring.message code='manage' /></button>
                           </div>
                       </div>
                               ...
                               <a href="${contextPath}/analysis/dataSet/pagingQuery">
                                   ...
                                   <#if currentUser.anonymous>
                                       <span class="ui-icon ui-icon-notice"
                                             title="<@spring.message code='main.anonymousDataTip' />"
                                             show-any-role="${Role.ROLE_DATA_ADMIN}"></span>
                                   </#if>
                               </a>
                           </li>
        ...
        <div id="${pageId}-mainTabs" class="main-tabs">
            ...
            <div class="tabs-more-operation-menu-wrapper ui-widget ui-front ui-widget-content ui-corner-all ui-widget-shadow"
                ...
                <ul class="tabs-more-operation-menu">
                    ...
                    <li class="ui-widget-header"></li>
                    <li class="tab-operation-newwin">
                        <div><@spring.message code='main.openInNewWindow' /></div>
                    </li>
                </ul>
            </div>
...
/*
        layui.config({
            ...
            if (username != '' && password != '' && username != undefined && password != undefined) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/login/doLogin?name=' + username + '&password=' + password,
                    async: true,
                    ...
                    error: function () {
                        //layer.msg('跳转失败！', {icon: 2, time: 2000});
                    }
                });
        ...
        po.activeWorkTabForAnalyze = function (tabId, tabLabel, tabTitle, url, schema) {


            /*          var styleElement = document.getElementById(tabId);
                      styleElement.style.cssText = 'overflow: hidden';*/
            ...
            if (tab.length > 0) {
                ...
                if (tabPanel.length == 0)
                    tabPanel = $("<div  style=\"overflow:hidden\" id='" + tabId + "'></div>").appendTo(po.mainTabs);
                po.mainTabs.tabs("refresh").tabs("option", "active", tab.index());
                tabPanel.css("top", po.evalTabPanelTop(po.mainTabs));
...
*/
        ...
        po.initSchemaPanelContent = function ($element) {
            ...
            var rrrr = document.body.clientHeight;
            $element.jstree
            (
                {
                    "core":
                ...
                .bind("select_node.jstree", function (e, data) {
                    ...
                    if (data.node.parent == "#") { //表示是父级（在这里即为数据源）


                        var schema = tree.get_node(data.node).original;
                        var tableInfo = data.node.original;
                        tableInfo.name = '';
                        tableInfo.type = '';
                        var tabTitle = tableInfo.type + "<@spring.message code='colon' />" + tableInfo.name;

                        var queryUrl = '/data-order-server/sqlpad/' + schema.id;

                    //    var tabUrl = '/data-order-server/htmls/analyze/html/basic.html?dbId=' + schema.id + '&url=' + schema.url;

                     //   po.activeWorkTabForAnalyze(po.toMainTabIdForSchemaName(schema.id, tableInfo.name), data.node.text, tabTitle, tabUrl, schema);
                        po.activeWorkTabForAnalyze(po.toMainTabIdForSchemaName(schema.id, tableInfo.name), data.node.text, tabTitle, queryUrl, schema);


                    } else if (po.isTableNode(data.node)) {
            ...
            po.element("#${pageId}-nav").tabs(
                {
                    ...
                    activate: function (event, ui) {
                        ...
                        $.cookie("MAIN_NAV_ACTIVE_TAB_INDEX", newTabIndex, {
                            expires: 365 * 5,
                            path: "${contextPath}"
                        });
                    }
