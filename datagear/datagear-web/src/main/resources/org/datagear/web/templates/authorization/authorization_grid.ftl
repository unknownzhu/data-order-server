...
<head>
    ...
    <title><#include "../include/html_title_app_name.ftl"><@spring.message code='${titleMessageKey}' />
        - <@spring.message code='${resourceMeta.resouceTypeLabel}' /></title>
</head>
    ...
    <div id="${pageId}" class="page-grid page-grid-hidden-foot page-grid-authorization">
        <div class="head">
            ...
            <div class="operation">
                ...
                <input name="addDbSourceButton" type="button" value="<@spring.message code='addDbSource' />"/>
            </div>
        </div>
        <div class="content">
...
<script type="text/javascript">
    (function (po) {
        ...
        po.element("input[name=addDbSourceButton]").click(function () {
            po.open(contextPath + "/schema/add" ,
                {
                    "pageParam":
                        {
                            "afterSave": function () {
        ...
        var tableColumns = [
            ...
            $.buildDataTablesColumnSimpleOption($.buildDataTablesColumnTitleSearchable("资源名称"), "schemaTitle"),
