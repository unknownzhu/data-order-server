...
<html>
<head>
    <script src="/data-order-server/component/layui/layui.js" charset="utf-8"></script>
...
<#if !isAjaxRequest>
    ...
    <div id="backToTop" style="position:fixed;right:0;bottom:0; background-color: none;border: none;text-align: center">
        <#-- <img src="/static/cms_front/images/backToTop.png" width="30px"/>-->
...
<div class="fill-parent">
    ...
    <div id="${pageId}" class="page-sqlpad">
        <div class="head button-operation">
            <button id="executeSqlButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only first"
                    title="<@spring.message code='sqlpad.executeWithShortcut' />"><span
                        class="ui-button-icon ui-icon ui-icon-play"></span><span
                        class="ui-button-icon-space"> </span><@spring.message code='execute' /></button>
            <button id="stopSqlButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                    title="<@spring.message code='sqlpad.stopExecution' />"><span
                        class="ui-button-icon ui-icon ui-icon-stop"></span><span
                        class="ui-button-icon-space"> </span><@spring.message code='sqlpad.stopExecution' /></button>
            <div class="button-divider ui-widget ui-widget-content"></div>
            <button id="commitSqlButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                    title="<@spring.message code='sqlpad.commit' />"><span
                        class="ui-button-icon ui-icon ui-icon-check"></span><span
                        class="ui-button-icon-space"> </span><@spring.message code='sqlpad.commit' /></button>
            <button id="rollbackSqlButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                    title="<@spring.message code='sqlpad.rollback' />"><span
                        class="ui-button-icon ui-icon ui-icon-arrowreturnthick-1-w"></span><span
                        class="ui-button-icon-space"> </span><@spring.message code='sqlpad.rollback' /></button>
            <div class="button-divider ui-widget ui-widget-content"></div>
            <#--禁用插入文件功能，因为没有应用场景
            ...
            -->
            <input id="sqlDelimiterInput" type="text"
                   class="sql-delimiter-input ui-widget ui-widget-content ui-corner-all" value=";"
                   title="<@spring.message code='sqlpad.sqlDelimiter' />"/>
            <button id="insertSqlDelimiterDefineButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                    title="<@spring.message code='sqlpad.insertSqlDelimiterDefine' />"><span
                        class="ui-button-icon ui-icon ui-icon-grip-dotted-horizontal"></span><span
                        class="ui-button-icon-space"> </span><@spring.message code='sqlpad.insertSqlDelimiterDefine' />
            </button>
            <button id="insertSqlDelimiterButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                    title="<@spring.message code='sqlpad.insertSqlDelimiter' />"><span
                        class="ui-button-icon ui-icon ui-icon-grip-solid-horizontal"></span><span
                        class="ui-button-icon-space"> </span><@spring.message code='sqlpad.insertSqlDelimiter' />
            </button>
            <div class="button-divider ui-widget ui-widget-content"></div>
            <button id="clearSqlButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                    title="<@spring.message code='sqlpad.clearEditSql' />"><span
                        class="ui-button-icon ui-icon ui-icon-trash"></span><span
                        class="ui-button-icon-space"> </span><@spring.message code='sqlpad.clearEditSql' /></button>

            <#--       <button id="commonSqlButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                           title="常用语句"><span
                               class="ui-button-icon ui-icon  ui-icon-note"></span><span
                               class="ui-button-icon-space"> </span>常用语句
                   </button>-->

            <div class="setting-wrapper">
                <button id="settingButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                        title="<@spring.message code='sqlpad.setting' />"><span
                            class="ui-button-icon ui-icon ui-icon-caret-1-s"></span><span
                            class="ui-button-icon-space"> </span><@spring.message code='sqlpad.setting' /></button>
                        ...
                        <div class="form-content">
                            <div class="form-item">
                                <div class="form-item-label">
                                    <label><@spring.message code='sqlpad.sqlCommitMode' /></label></div>
                                <div class="form-item-value">
                                    <div id="sqlCommitModeSet" class="ui-corner-all">
                                        <input type="radio" id="${pageId}-sqlcm-0" name="sqlCommitMode"
                                               value="AUTO"><label
                                                for="${pageId}-sqlcm-0"><@spring.message code='sqlpad.sqlCommitMode.auto' /></label>
                                        <input type="radio" id="${pageId}-sqlcm-1" name="sqlCommitMode"
                                               value="MANUAL"><label
                                                for="${pageId}-sqlcm-1"><@spring.message code='sqlpad.sqlCommitMode.manual' /></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-item">
                                <div class="form-item-label">
                                    <label><@spring.message code='sqlpad.sqlExceptionHandleMode' /></label></div>
                                <div class="form-item-value">
                                    <div id="sqlExceptionHandleModeSet" class="ui-corner-all">
                                        <input type="radio" id="${pageId}-sqlehm-0" name="sqlExceptionHandleMode"
                                               value="ABORT" checked="checked"><label
                                                for="${pageId}-sqlehm-0"><@spring.message code='sqlpad.sqlExceptionHandleMode.abort' /></label>
                                        <input type="radio" id="${pageId}-sqlehm-1" name="sqlExceptionHandleMode"
                                               value="IGNORE"><label
                                                for="${pageId}-sqlehm-1"><@spring.message code='sqlpad.sqlExceptionHandleMode.ignore' /></label>
                                        <input type="radio" id="${pageId}-sqlehm-2" name="sqlExceptionHandleMode"
                                               value="ROLLBACK"><label
                                                for="${pageId}-sqlehm-2"><@spring.message code='sqlpad.sqlExceptionHandleMode.rollback' /></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-item">
                                <div class="form-item-label">
                                    <label><@spring.message code='sqlpad.overTimeThreashold' /></label></div>
                                <div class="form-item-value">
                                    <input type="text" name="overTimeThreashold" value="10"
                                           class="ui-widget ui-widget-content" style="width:4em;"
                            ...
                            <div class="form-item">
                                <div class="form-item-label">
                                    <label><@spring.message code='sqlpad.resultsetFetchSize' /></label></div>
                                <div class="form-item-value">
                                    <input type="text" name="resultsetFetchSize" value="20"
                                           class="ui-widget ui-widget-content" style="width:4em;"
            ...
            <div class="view-sql-history-wrapper">
                <button id="viewSqlHistoryButton" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                        title="常用语句"><span
                            class="ui-button-icon ui-icon ui-icon-note"></span><span
                            class="ui-button-icon-space"> </span>常用语句
                </button>
                <button id="viewSqlHistoryButton1" class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                        title="历史语句"><span
                            class="ui-button-icon ui-icon ui-icon-clock"></span><span
                            class="ui-button-icon-space"> </span>历史语句
                </button>
               ...
               title="常用语句"><span
                ...
                <div class="view-sql-history-panel ui-widget ui-widget-content ui-corner-all ui-widget-shadow ui-front">
                    <div class="sql-history-head">
                        <div id="viewSqlHistorySearchForm" method="post"
                                <#-- action="${contextPath}/sqlpad/${schema.id}/sqlHistoryData"-->
                             action='/data-order-server/system/commonSql/linkDataForSqlPad'
                                <#--system/commonSql/linkData?page=1&limit=10-->
                             class="sql-history-search-form">
                            <input type="hidden" name="page" id="page" value="1"/>
                            <input type="hidden" name="limit" id="limit" value="20"/>
                            <div class="form-content">
                                <div class="form-item">
                                    <div class="form-item-value">
                                        <input type="text" name="keyword" id="keyword" value="" class="ui-widget ui-widget-content"
                                               maxlength="50"/>
                                        <button type="submit"
                                                id="viewSqlHistorySearchFormQuery"><@spring.message code='query' /></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="sql-history-operation">
                            <button id="insertSqlHistoryToEditorButton"
                                    title="<@spring.message code='sqlpad.insertSqlHistoryToEditor' />"><@spring.message code='insert' /></button>
                            <button id="copySqlHistoryToClipbordButton"
                                    title="<@spring.message code='sqlpad.copySqlHistoryToClipbord' />"><@spring.message code='copy' /></button>
                        </div>
                    </div>
                    <div class="sql-history-list ui-widget ui-widget-content">
                    </div>
                    <div class="sql-history-foot">
                        <button id="sqlHistoryLoadMoreButton"
                                class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                                title="<@spring.message code='loadMore' />"><span
                                    class="ui-button-icon ui-icon ui-icon-arrowthick-1-s"></span><span
                                    class="ui-button-icon-space"> </span><@spring.message code='loadMore' /></button>
                        <button id="sqlHistoryRefreshButton"
                                class="ui-button ui-corner-all ui-widget ui-button-icon-only"
                                title="<@spring.message code='refresh' />"><span
                                    class="ui-button-icon ui-icon ui-icon-refresh"></span><span
                                    class="ui-button-icon-space"> </span><@spring.message code='refresh' /></button>
                    </div>
                </div>
            </div>
        </div>
        <div class="content ui-widget ui-widget-content">
            ...
            <div class="content-result">
                <div id="${pageId}-sqlResultTabs" class="result-tabs minor-tabs minor-dataTable">
                    <ul>
                        <li class="result-message-tab not-closable"><a class="result-message-anchor"
                                                                       href="#${pageId}-resultMessage"><@spring.message code='sqlpad.message' /></a>
                        </li>
                    </ul>
                    <div id="${pageId}-resultMessage" class="result-message">
                    </div>
                    <div class="tabs-more-operation-menu-wrapper ui-widget ui-front ui-widget-content ui-corner-all ui-widget-shadow"
                         style="position: absolute; left:0px; top:0px; display: none;">
                        <ul class="tabs-more-operation-menu">
                            <li class="tab-operation-close-left">
                                <div><@spring.message code='main.closeLeft' /></div>
                            </li>
                            <li class="tab-operation-close-right">
                                <div><@spring.message code='main.closeRight' /></div>
                            </li>
                            <li class="tab-operation-close-other">
                                <div><@spring.message code='main.closeOther' /></div>
                            </li>
                            <li class="tab-operation-close-all">
                                <div><@spring.message code='main.closeAll' /></div>
                            </li>
                        </ul>
                    </div>
                    <div class="tabs-more-tab-menu-wrapper ui-widget ui-front ui-widget-content ui-corner-all ui-widget-shadow"
                         style="position: absolute; left:0px; top:0px; display: none;">
                        <ul class="tabs-more-tab-menu">
                        </ul>
                    </div>
                    <div id="viewLongTextResultPanel"
                         class="view-long-text-result-panel ui-widget ui-front ui-widget-content ui-corner-all ui-widget-shadow">
                ...
                <div class="result-operations button-operation">
                    <div class="result-message-buttons">
                        <#--<button id="toggleAutoClearResultButton"
                                class="result-message-button ui-button ui-corner-all ui-widget ui-button-icon-only stated-active"
                                title="<@spring.message code='sqlpad.keepResult' />"><span
                                    class="ui-button-icon ui-icon ui-icon-pin-s"></span><span
                                    class="ui-button-icon-space"> </span><@spring.message code='sqlpad.keepResult' />
                        </button>-->
                        <button id="clearSqlResultMessageButton"
                                class="result-message-button ui-button ui-corner-all ui-widget ui-button-icon-only"
                                title="<@spring.message code='sqlpad.clearSqlResultMessage' />"><span
                                    class="ui-button-icon ui-icon ui-icon-trash"></span><span
                                    class="ui-button-icon-space"> </span><@spring.message code='sqlpad.clearSqlResultMessage' />
                        </button>
                    </div>
                        <div class="sql-result-buttons" >
                        <button id="moreSqlResultTabButton"
                                class="sql-result-button ui-button ui-corner-all ui-widget ui-button-icon-only"
                                title="<@spring.message code='sqlpad.loadMoreData' />"><span
                                    class="ui-button-icon ui-icon ui-icon-arrowthick-1-s"></span><span
                                    class="ui-button-icon-space"> </span><@spring.message code='sqlpad.loadMoreData' />
                        </button>
                        <button id="refreshSqlResultTabButton"
                                class="sql-result-button ui-button ui-corner-all ui-widget ui-button-icon-only"
                                title="<@spring.message code='sqlpad.refreshSqlResult' />"><span
                                    class="ui-button-icon ui-icon ui-icon-refresh"></span><span
                                    class="ui-button-icon-space"> </span><@spring.message code='sqlpad.refreshSqlResult' />
                        </button>
                   <#--  隐藏导出等按钮
                      <button id="exportSqlResultTabButton"
                              class="sql-result-button ui-button ui-corner-all ui-widget ui-button-icon-only"
                              title="<@spring.message code='sqlpad.exportSqlResult' />"><span
                                  class="ui-button-icon ui-icon ui-icon-arrowthick-1-ne"></span><span
                                  class="ui-button-icon-space"> </span><@spring.message code='sqlpad.exportSqlResult' />
                      </button>
                      &nbsp;&nbsp;
                      <button id="viewSqlResultTabButton"
                              class="sql-result-button ui-button ui-corner-all ui-widget ui-button-icon-only"
                              title="<@spring.message code='sqlpad.viewSqlStatement' />"><span
                                  class="ui-button-icon ui-icon ui-icon-lightbulb"></span><span
                                  class="ui-button-icon-space"> </span><@spring.message code='sqlpad.viewSqlStatement' />
                      </button>
                      <button id="lockSqlResultTabButton"
                              class="sql-result-button ui-button ui-corner-all ui-widget ui-button-icon-only stated-active"
                              title="<@spring.message code='sqlpad.lockSqlResultTab' />"><span
                                  class="ui-button-icon ui-icon ui-icon-locked"></span><span
                                  class="ui-button-icon-space"> </span><@spring.message code='sqlpad.lockSqlResultTab' />
                      </button>
                  </div>-->
                </div>
                <div id="viewSqlStatementPanel"
                     class="view-sql-statement-panel ui-widget ui-front ui-widget-content ui-corner-all ui-widget-shadow">
        ...
        <div id="sqlExceptionDetailPanel"
             class="sql-exception-detail-panel ui-widget ui-widget-content ui-corner-all ui-widget-shadow">
    ...
    <#if !isAjaxRequest>
  <#--  <input id="sqlWordCombainInput" type="text" value="tewteteewttew" name="sqlWordCombainInput"
    >-->
</div>
</#if>
...
<script type="text/javascript">
    ...
    (function (po) {
            ...
            $.ajax(
                {
                    ...
                    , success: function (result) {
                        ...
                        $.ajax(
                            {
                                type: "POST",
                                url: window.location.protocol + "/data-order-server/system/historySql/" + po.schemaId + "/execute",
                                data: data,
                                async: false
                                , success: function (result) {
                                }
                ...
                if (msgData.detailTrace) {
                    ...
                    $seInfoSummary.click(function (event) {
                        ...
                        if (!$seDetailPanel.is(":hidden") && uid == $seDetailPanel.attr("uid"))
                            ...
                            $seDetailPanel.show().position({
                                my: "center bottom",
                                at: "center top",
                                of: po.resultMessageElement
                            });
                        }
                    });
                }
        ...
        layui.config({
            ...
            window.layerAlert = function () {
                layer.msg('仅查询语句可用！', {icon: 2, time: 2000});
            }

            window.checkSql = function (sql) {
                var flag = false;
                var reg = /(\bdelete\b)|(\binsert\b)|(\bupdate\b)|(\balter\b)|(\bcreate\b)|(\bdrop\b)|(\btruncate\b)/ig
            ...
            window.viewSqlHistoryButton1 = function (po) {
                ///   '/htmls/analyze/html/basic.html?dbId=' + schema.id + '&url=' + schema.url;
                layer.open({
                    type: 2,
                    title: '历史语句',
                    shade: 0.1,
                    shadeClose: true,
                    area: ['80%', '620px'],
                    content: '/data-order-server/htmls/commonSql/collect.html'
                });
            }
        ...
        /*        po.element("#commonSqlButton").click(function () {
                    commonSqlButton(po);
                });*/

        po.element("#viewSqlHistoryButton1").click(function () {
            viewSqlHistoryButton1(po);
        });
        ...
        po.element("#viewSqlHistorySearchFormQuery").click(function () {
            // var page = $("#page").val();
            // var limit = $("#limit").val();
            var page = '1';
            var limit = '100';
            var sqls = $("#keyword").val();
            $.ajax({
                url: "/data-order-server/system/commonSql/linkData?page=" + page + "&limit=" + limit + "&sqls=" + sqls,
                dataType: 'json',
                type: 'get',
                success: function (result) {

                    //success: function (pagingData, statusText, xhr, $form)
                    var pagingData = result.data
                    var sqlHistories = pagingData;
                    var $form = $("#viewSqlHistorySearchForm");

                    var pages = Math.ceil(pagingData.count / limit);
                    if (page >= pages)
                    ...
                    for (var i = 0; i < sqlHistories.length; i++) {
                        ...
                        $("<div/>").text(sqlHistory.createTime).appendTo($item);
                        $("<div class='sql-content' />").text(sqlHistory.sqls).appendTo($item);
        ...
        po.element("#viewSqlHistoryButton").click(function () {
            ...
            var limit = '100';
            $.ajax({
                url: "/data-order-server/system/commonSql/linkData?page=" + page + "&limit=" + limit,
                dataType: 'json',
                type: 'get',
                success: function (result) {
