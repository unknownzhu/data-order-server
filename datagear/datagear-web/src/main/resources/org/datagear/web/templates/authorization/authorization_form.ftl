		...
		<div class="form-content">
			...
			<#else>
				...
				<div class="form-item form-item-resource-name-entity">
					...
					<div class="form-item-value">
						<input type="text" name="resourceNameForEntity" value="${isResourceTypePattern?string('', (authorization.schemaTitle )!'')}" class="ui-widget ui-widget-content" readonly="readonly" />
						<#if !readonly>
				...
				<div class="form-item form-item-resource-name-pattern">
					...
					<div class="form-item-value">
						<input type="text" name="resourceNameForPattern" value="${(!isResourceTypePattern)?string('', (authorization.schemaTitle )!'')}" class="ui-widget ui-widget-content" />
						<#if !readonly>
						<#--占位按钮，避免切换时界面尺寸变化-->
