...
<form id="${pageId}-searchForm" class="search-form" action="#" tabindex="0">
	...
	<span class="ui-icon like-switch-icon ui-icon-radio-off" title="<@spring.message code='data.likeTitle' />"></span><div class="keyword-input-parent"><input name="keyword" id="keyword" type="text" class="ui-widget ui-widget-content keyword-input" tabindex="2" title="<@spring.message code='data.keywordTitle' />" /></div>
