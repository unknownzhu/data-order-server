...
public abstract class AbstractSchemaConnController extends AbstractController
{
	 ...
	 * @throws SchemaNotFoundException
	 */
	public Schema getSchemaNotNull(String schemaId) throws SchemaNotFoundException
	{
	 ...
	 */
	public Connection getSchemaConnection(Schema schema) throws ConnectionSourceException
	{
