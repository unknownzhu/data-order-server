...
public class SchemaUrlBuilderController extends AbstractController implements ServletContextAware {
    ...
    @RequestMapping("/builtInBuildersJson")
    public Object builtInBuildersJson(HttpServletRequest request, @RequestParam(value = "url", required = false) String url)
            throws IOException {
        String result = getBuiltInUrlBuildersJson();
